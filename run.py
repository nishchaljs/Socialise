...
netres = "Barack Obama in 2004 was unknown to most of the people. Dont know where this guy came from, but the effect he had was massive. Recoupment 2004 with unknown fever sign I don't know who this guy is what was the effect that he had occasion as everyone up started. As a young rising figure in the sky was this assistance is uses of people were saying I dont know who this guy is what was the effect that he had"
...
def imagecaption():
    ...
    if(request.args['submit_button']=='Image Caption'):
...
def textcaption():
    pythoncom.CoInitialize()
    if(request.args['submit_button']=='Text Caption'):
...
#         print("AUDIO_FILE obtained")
        ...
        def print_time(result): 
            for i in range(len(result)):
                if(result[i] in arr):
                        ...
                        ImageNumpyFormat = cv2.resize(ImageNumpyFormat,(512,512))
        ...
        # Capture frame-by-frame 
            try:
                ...
                if ret != True: 
                    ...
                    if(j-i > x):
                        with audio as source:
                            audio_file = r.record(source, duration=60, offset = x)
                ...
                # Break the loop 
                    ...
                    _thread.start_new_thread(print_time, (netres,) )
                    print(netres)
                    break
                                        # Press Q on keyboard to  exit 
                    if cv2.waitKey(25) & 0xFF == ord('q'): 
        ...
        return render_template('index.html',token=netres)
